  ...
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" :inline="true" label-width="90px">
              ...
              <el-form-item label="入库状态" prop="stockStatus" class="col4">
                <el-select v-model="queryParams.stockStatus" placeholder="请选择入库状态" clearable style="width: 100%">
                  <el-option
          ...
          <template #default="scope">
            ...
            <div>
              ...
              <el-popover
                ...
                :content="'订单【' + scope.row.docNo + '】未审核或已全部入库！'"
              >
                <template #reference>
