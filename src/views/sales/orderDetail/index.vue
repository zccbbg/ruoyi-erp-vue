      ...
      <el-row :gutter="10" class="mb8" type="flex" justify="space-between">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['sales:orderDetail:add']"
          >新增</el-button>
          <el-button
            type="warning"
            plain
            icon="Download"
            @click="handleExport"
            v-hasPermi="['sales:orderDetail:export']"
          >导出</el-button>
        </el-col>
      </el-row>
      ...
      <el-table v-loading="loading" :data="orderDetailList" border class="mt20">
        ...
        <el-table-column label="操作" align="right" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['sales:orderDetail:edit']">修改</el-button>
            <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['sales:orderDetail:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script setup name="OrderDetail">
  import { listOrderDetail, getOrderDetail, delOrderDetail, addOrderDetail, updateOrderDetail } from "@/api/sales/orderDetail";
...
function handleExport() {
  proxy.download('sales/orderDetail/export', {
    ...queryParams.value
