      ...
      <el-row :gutter="10" class="mb8" type="flex" justify="space-between">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['sales:refundDetail:add']"
          >新增</el-button>
          <el-button
            type="warning"
            plain
            icon="Download"
            @click="handleExport"
            v-hasPermi="['sales:refundDetail:export']"
          >导出</el-button>
        </el-col>
      </el-row>
      ...
      <el-table v-loading="loading" :data="refundDetailList" border class="mt20">
        ...
        <el-table-column label="操作" align="right" class-name="small-padding fixed-width">
            <template #default="scope">
                <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['sales:refundDetail:edit']">修改</el-button>
                <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['sales:refundDetail:remove']">删除</el-button>
            </template>
        </el-table-column>
      </el-table>
...
import { listRefundDetail, getRefundDetail, delRefundDetail, addRefundDetail, updateRefundDetail } from "@/api/sales/refundDetail";
...
function handleExport() {
  proxy.download('sales/refundDetail/export', {
    ...queryParams.value
