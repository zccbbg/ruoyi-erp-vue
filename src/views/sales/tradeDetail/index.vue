      ...
      <el-row :gutter="10" class="mb8" type="flex" justify="space-between">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['sales:tradeDetail:add']"
          >新增</el-button>
          <el-button
            type="warning"
            plain
            icon="Download"
            @click="handleExport"
            v-hasPermi="['sales:tradeDetail:export']"
          >导出</el-button>
        </el-col>
      </el-row>
      ...
      <el-table v-loading="loading" :data="tradeDetailList" border class="mt20">
        ...
        <el-table-column label="操作" align="right" class-name="small-padding fixed-width">
            <template #default="scope">
                <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['sales:tradeDetail:edit']">修改</el-button>
                <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['sales:tradeDetail:remove']">删除</el-button>
            </template>
        </el-table-column>
      </el-table>
...
import { listTradeDetail, getTradeDetail, delTradeDetail, addTradeDetail, updateTradeDetail } from "@/api/sales/tradeDetail";
...
function handleExport() {
  proxy.download('sales/tradeDetail/export', {
    ...queryParams.value
